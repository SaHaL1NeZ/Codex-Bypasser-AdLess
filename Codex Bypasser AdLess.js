...
// @connect      *
// @version      1.2
// @icon         https://www.google.com/s2/favicons?sz=32&domain=codex.lol
// @run-at       document-end
...
Promise.resolve(true)
  .then(data => {
if (document.title=='Waiting for magic to start...') {
    return;
}
 (() => {
